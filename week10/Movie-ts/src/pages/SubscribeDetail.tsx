...
const SubscribeDetail: React.FC = () => {
    ...
    const { data: creditsData, isLoading: isCreditsLoading } = useCustomFetch<CreditData>(`/movie/${movieId}/credits?language=ko-KR`);
    const { data: reviewsData, isLoading: isReviewsLoading } = useCustomFetch<ReviewData>(`/movie/${movieId}/reviews?language=ko-KR`);
